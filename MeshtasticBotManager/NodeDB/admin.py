...
class PositionAdmin(admin.ModelAdmin):
    list_display = ('node', 'logged_time', 'latitude', 'longitude', 'altitude', 'location_source')


@admin.register(DeviceMetrics)
class DeviceMetricsAdmin(admin.ModelAdmin):
    list_display = (
        'node', 'logged_time', 'battery_level', 'voltage', 'channel_utilization', 'air_util_tx', 'uptime_seconds')
